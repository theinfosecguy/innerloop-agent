...
const telemetryAllowlists = Object.freeze({
  ...
  clientVersions: ['1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.3.1', '1.3.2', '1.3.3', '1.3.4', '1.4.0', '1.4.1', '1.4.2', '1.5.0', '1.6.0', 'unknown'],
});
...
assert(
  Array.isArray(manifest.retiredClientDigests) && manifest.retiredClientDigests.length === 12,
